...
int main() {
    ...
    while(1){
        ...
        else if(choice==7)removeDoctor(doctors,&doctorCount);
        else if(choice==8)removePatient(patients,&patientCount);
        else if(choice==9)searchDoctorByName(doctors,doctorCount);
        else if(choice==10)searchDoctorBySpecialization(doctors,doctorCount);
        else if(choice==11)searchPatientByName(patients,patientCount);
        else if(choice==12)searchPatientByDisease(patients,patientCount);
        else if(choice==13)doctorWithHighestExperience(doctors,doctorCount);
        else if(choice==14)patientWithMaxDue(patients,patientCount);
        else if(choice==15){
...
void searchDoctorBySpecialization(struct Doctor doctors[],int doctorCount) {
    ...
    else printf("No doctor with that specialization found.\n");
}
void searchPatientByName(struct Patient patients[],int patientCount) {
    char name[100];
    int found_index;
...
void searchPatientByDisease(struct Patient patients[],int patientCount) {
    ...
    else printf("No patient with that disease found.\n");
}
void doctorWithHighestExperience(struct Doctor doctors[],int doctorCount) {
    if (doctorCount==0) {
        printf("No doctors available.\n");
